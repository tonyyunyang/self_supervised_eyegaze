...
from modules.pretrain_hyperparameters import KDD_NoMask_Pretrain_Hyperparameters, KDD_Pretrain_Hyperparameters
from utils.finetune import finetune_kdd_model, eval_finetune_kdd_model
from utils.load_data_from_file import load_mixed_data, load_uci_one_out_data, prepare_mixed_data_loader, load_one_out_data, prepare_no_mask_one_out_data_loader, \
...
def main():
    ...
    config["general"]["test_set"] = "UCI" # Reading or Desktop or CosSin 

    config["general"]["window_size"] = 128
    config["general"]["overlap"] = 0.5
    ...
    if config["general"]["test_mode"] == "Mixed":
        ...
        train_data, train_labels, test_data, test_labels, encoder = (load_uci_one_out_data
