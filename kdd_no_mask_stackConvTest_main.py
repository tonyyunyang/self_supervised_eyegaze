...
def main():
    ...
    # config["general"]["pretrain_model"] = "results/Desktop/kdd_model/One_out/convolution/pretrain/window_size_5sec/feat_dim_2/kernelsize_20_stride_10_dilation_1_padding_0/freeze_False_epoch_1200_lr_0.001_d_hidden_64_d_ff_128_n_heads_8_n_layer_8_pos_encode_learnable_activation_gelu_norm_BatchNorm"

    config["general"]["test_set"] = "Desktop" # Reading or Desktop or CosSin

    config["general"]["window_size"] = 450
    config["general"]["overlap"] = 0.8
    config["general"]["batch_size"] = 128
    config["kdd_pretrain"]["epoch"] = 2400
