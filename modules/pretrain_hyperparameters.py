...
class KDD_NoMask_Pretrain_Hyperparameters:
    def __init__(self, config):
        self.epoch = config["kdd_pretrain"]["epoch"]
        self.batch = config["general"]["batch_size"]
        self.lr = config["kdd_pretrain"]["lr"]
        ...
        self.loss = NoMaskedMSELoss(reduction='none')  # outputs loss for each batch element
...
class KDD_Fully_Supervised_Pretrain_Hyperparameters:
    def __init__(self, config):
        self.epoch = config["kdd_pretrain"]["epoch"]
        self.batch = config["general"]["batch_size"]
        self.lr = config["kdd_pretrain"]["lr"]
